...
describe('ProfitTargetCalculator logic', () => {
  ...
  let fixture: ComponentFixture<ProfitTargetCalculator>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [ProfitTargetCalculator],
      providers: [provideHttpClient(), provideHttpClientTesting()],
    }).compileComponents();

    fixture = TestBed.createComponent(ProfitTargetCalculator);
    component = fixture.componentInstance;

    component.balance.set(1000);
    component.riskPercent.set(1);
    component.entryPrice.set(2.6);
    component.tpSlRatio.set(2);
    component.leverage.set(10);

    component.targetPrice.set(2.7);
    component.onTargetPriceInput();
  ...
  it('should reset to default values', () => {
    component.balance.set(999);
    component.riskPercent.set(9);
    component.reset();
  ...
  it('should calculate targetPrice from desiredProfit (autoTarget = true)', () => {
    component.desiredProfit.set(25);
    component.onDesiredProfitInput();
    component.updateDerivedValues();
